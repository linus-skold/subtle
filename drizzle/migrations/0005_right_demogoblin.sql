...
CREATE TABLE `__new_tasks` (
	...
	`created_at` text DEFAULT '2025-07-07T22:42:31.918Z',
	`updated_at` text DEFAULT '2025-07-07T22:42:31.919Z',
...
CREATE TABLE `__new_notes` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`note` text DEFAULT '',
	`created_at` text DEFAULT '2025-07-07T22:42:31.933Z',
	`updated_at` text DEFAULT '2025-07-07T22:42:31.933Z'
);
--> statement-breakpoint
