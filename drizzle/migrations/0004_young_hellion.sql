...
CREATE TABLE `__new_tasks` (
	...
	`created_at` text DEFAULT '2025-06-22T22:05:49.622Z',
	`updated_at` text DEFAULT '2025-06-22T22:05:49.622Z',
...
CREATE TABLE `__new_notes` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`note` text DEFAULT '',
	`created_at` text DEFAULT '2025-06-22T22:05:49.636Z',
	`updated_at` text DEFAULT '2025-06-22T22:05:49.636Z'
);
--> statement-breakpoint
